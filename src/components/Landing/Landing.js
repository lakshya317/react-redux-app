    ...
    return (
        <div className="landing">
            <ErrorModal
                ...
                onHide={() => {
                    dispatch(removeDisplayError());
                }}
            />
            <Header />
            <div className="landing-body">
                <div className="landing-title">Welcome to an Application made using:</div>
                <div className="stack-container">
                    ...
                    <div className="stack-group">
                        <ReduxLogo
                            ...
                            className="no-tooltips"
                        />
                        <div className="stack-title">Redux</div>
                    </div>
                </div>
                <div className="login-button-container">
                    <Link className="login-link" to="/login" style={{ textDecoration: 'none' }}>
                        <div className="login-link-button">Login</div>
                    </Link>
                </div>
            </div>
        </div>
